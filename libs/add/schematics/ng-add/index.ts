...
export function ngAdd(options: Schema): Rule {
  return (tree: Tree, context: SchematicContext) => {
    ...
    addPackageJsonDependency(tree, { name: `@sijil/app`, version: NG_DOC_VERSION });
    addPackageJsonDependency(tree, { name: `@sijil/builder`, version: NG_DOC_VERSION });
    addPackageJsonDependency(tree, { name: `@sijil/ui-kit`, version: NG_DOC_VERSION });
    addPackageJsonDependency(tree, { name: `@sijil/core`, version: NG_DOC_VERSION });
    removePackageJsonDependency(tree, '@sijil/add');
